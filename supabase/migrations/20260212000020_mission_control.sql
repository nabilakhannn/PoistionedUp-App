...
CREATE INDEX IF NOT EXISTS idx_agent_tasks_assignee ON agent_tasks(user_id, assignee_id);
...
CREATE INDEX IF NOT EXISTS idx_agent_messages_task ON agent_messages(user_id, task_id);
CREATE INDEX IF NOT EXISTS idx_agent_messages_from ON agent_messages(user_id, from_agent_id);
CREATE INDEX IF NOT EXISTS idx_agent_messages_created ON agent_messages(user_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_agent_deliverables_task ON agent_deliverables(user_id, task_id);
