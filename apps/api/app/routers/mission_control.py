...
DEFAULT_AGENTS = [
    ...
    },
    {
        ...
        "avatar_emoji": "🔍",
        "skills": ["web-search", "trend-analysis", "market-research", "data-collection", "topic-discovery"],
        "about": "Research specialist who monitors market trends and uncovers content opportunities through web search and data analysis.",
    ...
    },
    {
        ...
        "model_name": "gpt-4o-mini",
        "avatar_emoji": "✅",
        "skills": ["quality-review", "voice-check", "ai-tell-detection", "virality-scoring", "content-scoring"],
        "about": "Quality gatekeeper who reviews all content before publishing. Scores on 6 dimensions (voice, hook, structure, AI-tells, virality, goals) and auto-triggers revisions when content doesn't meet the bar.",
        "workspace_path": "./agents/qa-reviewer",
    },
    {
        ...
        "model_name": "gpt-4o-mini",
        "avatar_emoji": "🎯",
        "skills": ["competitive-analysis", "threat-scoring", "positioning-detection", "benchmarking", "content-gap-analysis"],
        "about": "Competitive intelligence specialist who monitors competitors, calculates dynamic threat scores, detects positioning shifts, identifies content gaps, and surfaces actionable intelligence to stay ahead.",
        "workspace_path": "./agents/competitor-analyst",
    },
]
