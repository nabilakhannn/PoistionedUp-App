/**
 * Shared SVG icons for PositionedUp.
 *
 * WHY THIS FILE EXISTS:
 * @heroicons/react cannot be installed because it has peer dependency
 * conflicts with React 19 + Next.js 15. Instead of fighting npm, we
 * keep the SVGs we need here as lightweight components.
 *
 * DO NOT import from "@heroicons/react" anywhere in this project.
 * Import from "@/components/icons" instead.
 *
 * All icons use the Heroicons 24/outline style (strokeWidth 1.5).
...
export function ViewColumnsIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
